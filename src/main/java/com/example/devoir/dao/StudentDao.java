...
import com.example.devoir.model.Student;
...
public class StudentDao {
    ...
    private static final String SELECT_STUDENT_BY_ID = "select id,first_name, last_name, student_id, school, study_option, registration_yearfrom students where id =?";
    private static final String SELECT_ALL_STUDENTS = "select * fromstudents";
    ...
    private static final String SELECT_STUDENT_BY_LastName = "select id,first_name, last_name, student_id, school, study_option, registration_yearfrom students where last_name = ?";
...
// Step 4: Process the ResultSet object.
    ...
    public List<Student> selectStudentByLastNAme(String lastName) {
        List<Student> students = new ArrayList<>();
// Step 1: Establishing a Connection
        try (Connection connection = getConnection();
// Step 2:Create a statement using connection object
             PreparedStatement preparedStatement =
                     connection.prepareStatement(SELECT_STUDENT_BY_LastName);) {
